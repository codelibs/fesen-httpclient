...
import org.codelibs.fesen.opensearch.action.admin.cluster.decommission.awareness.delete.DeleteDecommissionStateRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.decommission.awareness.delete.DeleteDecommissionStateResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.decommission.awareness.get.GetDecommissionStateRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.decommission.awareness.get.GetDecommissionStateResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.decommission.awareness.put.DecommissionRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.decommission.awareness.put.DecommissionResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.node.reload.NodesReloadSecureSettingsRequestBuilder;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.remotestore.restore.RestoreRemoteStoreResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.repositories.cleanup.CleanupRepositoryRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.repositories.cleanup.CleanupRepositoryResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.shards.routing.weighted.delete.ClusterDeleteWeightedRoutingRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.shards.routing.weighted.delete.ClusterDeleteWeightedRoutingResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.shards.routing.weighted.get.ClusterGetWeightedRoutingRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.shards.routing.weighted.get.ClusterGetWeightedRoutingResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.shards.routing.weighted.put.ClusterPutWeightedRoutingRequestBuilder;
import org.codelibs.fesen.opensearch.action.admin.cluster.shards.routing.weighted.put.ClusterPutWeightedRoutingResponse;
...
import org.codelibs.fesen.opensearch.action.admin.cluster.snapshots.clone.CloneSnapshotRequestBuilder;
...
import org.codelibs.fesen.opensearch.action.admin.indices.dangling.delete.DeleteDanglingIndexRequest;
import org.codelibs.fesen.opensearch.action.admin.indices.dangling.import_index.ImportDanglingIndexAction;
import org.codelibs.fesen.opensearch.action.admin.indices.dangling.import_index.ImportDanglingIndexRequest;
import org.codelibs.fesen.opensearch.action.admin.indices.dangling.list.ListDanglingIndicesAction;
import org.codelibs.fesen.opensearch.action.admin.indices.dangling.list.ListDanglingIndicesRequest;
import org.codelibs.fesen.opensearch.action.admin.indices.dangling.list.ListDanglingIndicesResponse;
...
import org.codelibs.fesen.opensearch.action.search.DeleteSearchPipelineRequest;
...
import org.codelibs.fesen.opensearch.action.search.GetSearchPipelineRequest;
import org.codelibs.fesen.opensearch.action.search.GetSearchPipelineResponse;
...
public abstract class HttpAbstractClient implements Client {
    ...
    public <Request extends ActionRequest, Response extends ActionResponse> ActionFuture<Response> execute(
        ...
        final PlainActionFuture<Response> actionFuture = PlainActionFuture.newFuture();
    ...
    @Override
    public BulkRequestBuilder prepareBulk(@Nullable final String globalIndex) {
    ...
    static class Admin implements AdminClient {
        ...
        Admin(final OpenSearchClient client) {
    ...
    static class ClusterAdmin implements ClusterAdminClient {
        ...
        ClusterAdmin(final OpenSearchClient client) {
            this.client = client;
        }
        ...
        @Override
        public ClusterHealthRequestBuilder prepareHealth(final String... indices) {
        ...
        @Override
        public NodesInfoRequestBuilder prepareNodesInfo(final String... nodesIds) {
        ...
        @Override
        public NodesStatsRequestBuilder prepareNodesStats(final String... nodesIds) {
        ...
        @Override
        public NodesUsageRequestBuilder prepareNodesUsage(final String... nodesIds) {
            return new NodesUsageRequestBuilder(this, NodesUsageAction.INSTANCE).setNodesIds(nodesIds);
        }

        @Override
        public ActionFuture<ClusterStatsResponse> clusterStats(final ClusterStatsRequest request) {
            return execute(ClusterStatsAction.INSTANCE, request);
        }

        @Override
        public void clusterStats(final ClusterStatsRequest request, final ActionListener<ClusterStatsResponse> listener) {
        ...
        @Override
        public ActionFuture<NodesHotThreadsResponse> nodesHotThreads(final NodesHotThreadsRequest request) {
            return execute(NodesHotThreadsAction.INSTANCE, request);
        }

        @Override
        public void nodesHotThreads(final NodesHotThreadsRequest request, final ActionListener<NodesHotThreadsResponse> listener) {
            execute(NodesHotThreadsAction.INSTANCE, request, listener);
        }

        @Override
        public NodesHotThreadsRequestBuilder prepareNodesHotThreads(final String... nodesIds) {
        ...
        @Override
        public ListTasksRequestBuilder prepareListTasks(final String... nodesIds) {
        ...
        @Override
        public GetTaskRequestBuilder prepareGetTask(final String taskId) {
        ...
        @Override
        public void cancelTasks(final CancelTasksRequest request, final ActionListener<CancelTasksResponse> listener) {
            execute(CancelTasksAction.INSTANCE, request, listener);
        }

        @Override
        public CancelTasksRequestBuilder prepareCancelTasks(final String... nodesIds) {
        ...
        @Override
        public ClusterSearchShardsRequestBuilder prepareSearchShards(final String... indices) {
        ...
        @Override
        public ActionFuture<PendingClusterTasksResponse> pendingClusterTasks(final PendingClusterTasksRequest request) {
            return execute(PendingClusterTasksAction.INSTANCE, request);
        }

        @Override
        public void pendingClusterTasks(final PendingClusterTasksRequest request,
                final ActionListener<PendingClusterTasksResponse> listener) {
            execute(PendingClusterTasksAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> putRepository(final PutRepositoryRequest request) {
            return execute(PutRepositoryAction.INSTANCE, request);
        }

        @Override
        public void putRepository(final PutRepositoryRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(PutRepositoryAction.INSTANCE, request, listener);
        }

        @Override
        public PutRepositoryRequestBuilder preparePutRepository(final String name) {
            return new PutRepositoryRequestBuilder(this, PutRepositoryAction.INSTANCE, name);
        }

        @Override
        public ActionFuture<CreateSnapshotResponse> createSnapshot(final CreateSnapshotRequest request) {
            return execute(CreateSnapshotAction.INSTANCE, request);
        }

        @Override
        public void createSnapshot(final CreateSnapshotRequest request, final ActionListener<CreateSnapshotResponse> listener) {
            execute(CreateSnapshotAction.INSTANCE, request, listener);
        }

        @Override
        public CreateSnapshotRequestBuilder prepareCreateSnapshot(final String repository, final String name) {
            return new CreateSnapshotRequestBuilder(this, CreateSnapshotAction.INSTANCE, repository, name);
        }

        @Override
        public CloneSnapshotRequestBuilder prepareCloneSnapshot(final String repository, final String source, final String target) {
            return new CloneSnapshotRequestBuilder(this, CloneSnapshotAction.INSTANCE, repository, source, target);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> cloneSnapshot(final CloneSnapshotRequest request) {
            return execute(CloneSnapshotAction.INSTANCE, request);
        }

        @Override
        public void cloneSnapshot(final CloneSnapshotRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(CloneSnapshotAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<GetSnapshotsResponse> getSnapshots(final GetSnapshotsRequest request) {
            return execute(GetSnapshotsAction.INSTANCE, request);
        }

        @Override
        public void getSnapshots(final GetSnapshotsRequest request, final ActionListener<GetSnapshotsResponse> listener) {
            execute(GetSnapshotsAction.INSTANCE, request, listener);
        }

        @Override
        public GetSnapshotsRequestBuilder prepareGetSnapshots(final String repository) {
            return new GetSnapshotsRequestBuilder(this, GetSnapshotsAction.INSTANCE, repository);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> deleteSnapshot(final DeleteSnapshotRequest request) {
            return execute(DeleteSnapshotAction.INSTANCE, request);
        }

        @Override
        public void deleteSnapshot(final DeleteSnapshotRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(DeleteSnapshotAction.INSTANCE, request, listener);
        }

        @Override
        public DeleteSnapshotRequestBuilder prepareDeleteSnapshot(final String repository, final String... names) {
            return new DeleteSnapshotRequestBuilder(this, DeleteSnapshotAction.INSTANCE, repository, names);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> deleteRepository(final DeleteRepositoryRequest request) {
            return execute(DeleteRepositoryAction.INSTANCE, request);
        }

        @Override
        public void deleteRepository(final DeleteRepositoryRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(DeleteRepositoryAction.INSTANCE, request, listener);
        }

        @Override
        public DeleteRepositoryRequestBuilder prepareDeleteRepository(final String name) {
            return new DeleteRepositoryRequestBuilder(this, DeleteRepositoryAction.INSTANCE, name);
        }

        @Override
        public ActionFuture<VerifyRepositoryResponse> verifyRepository(final VerifyRepositoryRequest request) {
            return execute(VerifyRepositoryAction.INSTANCE, request);
        }

        @Override
        public void verifyRepository(final VerifyRepositoryRequest request, final ActionListener<VerifyRepositoryResponse> listener) {
            execute(VerifyRepositoryAction.INSTANCE, request, listener);
        }

        @Override
        public VerifyRepositoryRequestBuilder prepareVerifyRepository(final String name) {
            return new VerifyRepositoryRequestBuilder(this, VerifyRepositoryAction.INSTANCE, name);
        }

        @Override
        public ActionFuture<GetRepositoriesResponse> getRepositories(final GetRepositoriesRequest request) {
            return execute(GetRepositoriesAction.INSTANCE, request);
        }

        @Override
        public void getRepositories(final GetRepositoriesRequest request, final ActionListener<GetRepositoriesResponse> listener) {
            execute(GetRepositoriesAction.INSTANCE, request, listener);
        }

        @Override
        public GetRepositoriesRequestBuilder prepareGetRepositories(final String... name) {
            return new GetRepositoriesRequestBuilder(this, GetRepositoriesAction.INSTANCE, name);
        }

        @Override
        public CleanupRepositoryRequestBuilder prepareCleanupRepository(final String repository) {
            return new CleanupRepositoryRequestBuilder(this, CleanupRepositoryAction.INSTANCE, repository);
        }

        @Override
        public ActionFuture<CleanupRepositoryResponse> cleanupRepository(final CleanupRepositoryRequest request) {
            return execute(CleanupRepositoryAction.INSTANCE, request);
        }

        @Override
        public void cleanupRepository(final CleanupRepositoryRequest request, final ActionListener<CleanupRepositoryResponse> listener) {
            execute(CleanupRepositoryAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<RestoreSnapshotResponse> restoreSnapshot(final RestoreSnapshotRequest request) {
            return execute(RestoreSnapshotAction.INSTANCE, request);
        }

        @Override
        public void restoreSnapshot(final RestoreSnapshotRequest request, final ActionListener<RestoreSnapshotResponse> listener) {
            execute(RestoreSnapshotAction.INSTANCE, request, listener);
        }

        @Override
        public void restoreRemoteStore(final RestoreRemoteStoreRequest request, final ActionListener<RestoreRemoteStoreResponse> listener) {
            execute(RestoreRemoteStoreAction.INSTANCE, request, listener);
        }

        @Override
        public RestoreSnapshotRequestBuilder prepareRestoreSnapshot(final String repository, final String snapshot) {
            return new RestoreSnapshotRequestBuilder(this, RestoreSnapshotAction.INSTANCE, repository, snapshot);
        }

        @Override
        public ActionFuture<SnapshotsStatusResponse> snapshotsStatus(final SnapshotsStatusRequest request) {
            return execute(SnapshotsStatusAction.INSTANCE, request);
        }

        @Override
        public void snapshotsStatus(final SnapshotsStatusRequest request, final ActionListener<SnapshotsStatusResponse> listener) {
            execute(SnapshotsStatusAction.INSTANCE, request, listener);
        }

        @Override
        public SnapshotsStatusRequestBuilder prepareSnapshotStatus(final String repository) {
        ...
        @Override
        public void putPipeline(final PutPipelineRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(PutPipelineAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> putPipeline(final PutPipelineRequest request) {
        ...
        @Override
        public void deletePipeline(final DeletePipelineRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(DeletePipelineAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> deletePipeline(final DeletePipelineRequest request) {
        ...
        @Override
        public DeletePipelineRequestBuilder prepareDeletePipeline(final String id) {
            return new DeletePipelineRequestBuilder(this, DeletePipelineAction.INSTANCE, id);
        }

        @Override
        public void getPipeline(final GetPipelineRequest request, final ActionListener<GetPipelineResponse> listener) {
            execute(GetPipelineAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<GetPipelineResponse> getPipeline(final GetPipelineRequest request) {
            return execute(GetPipelineAction.INSTANCE, request);
        }

        @Override
        public GetPipelineRequestBuilder prepareGetPipeline(final String... ids) {
            return new GetPipelineRequestBuilder(this, GetPipelineAction.INSTANCE, ids);
        }

        @Override
        public void simulatePipeline(final SimulatePipelineRequest request, final ActionListener<SimulatePipelineResponse> listener) {
            execute(SimulatePipelineAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<SimulatePipelineResponse> simulatePipeline(final SimulatePipelineRequest request) {
        ...
        @Override
        public void allocationExplain(final ClusterAllocationExplainRequest request,
                final ActionListener<ClusterAllocationExplainResponse> listener) {
            execute(ClusterAllocationExplainAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<ClusterAllocationExplainResponse> allocationExplain(final ClusterAllocationExplainRequest request) {
        ...
        @Override
        public ActionFuture<ListDanglingIndicesResponse> listDanglingIndices(final ListDanglingIndicesRequest request) {
            return execute(ListDanglingIndicesAction.INSTANCE, request);
        }

        @Override
        public void listDanglingIndices(final ListDanglingIndicesRequest request,
                final ActionListener<ListDanglingIndicesResponse> listener) {
            execute(ListDanglingIndicesAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> importDanglingIndex(final ImportDanglingIndexRequest request) {
            return execute(ImportDanglingIndexAction.INSTANCE, request);
        }

        @Override
        public void importDanglingIndex(final ImportDanglingIndexRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(ImportDanglingIndexAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> deleteDanglingIndex(final DeleteDanglingIndexRequest request) {
            return execute(DeleteDanglingIndexAction.INSTANCE, request);
        }

        @Override
        public ActionFuture<ClusterPutWeightedRoutingResponse> putWeightedRouting(final ClusterPutWeightedRoutingRequest request) {
            return execute(ClusterAddWeightedRoutingAction.INSTANCE, request);
        }

        @Override
        public void putWeightedRouting(final ClusterPutWeightedRoutingRequest request,
                final ActionListener<ClusterPutWeightedRoutingResponse> listener) {
        ...
        @Override
        public ActionFuture<ClusterGetWeightedRoutingResponse> getWeightedRouting(final ClusterGetWeightedRoutingRequest request) {
            return execute(ClusterGetWeightedRoutingAction.INSTANCE, request);
        }

        @Override
        public void getWeightedRouting(final ClusterGetWeightedRoutingRequest request,
        ...
        @Override
        public ActionFuture<ClusterDeleteWeightedRoutingResponse> deleteWeightedRouting(final ClusterDeleteWeightedRoutingRequest request) {
            return execute(ClusterDeleteWeightedRoutingAction.INSTANCE, request);
        }

        @Override
        public void deleteWeightedRouting(final ClusterDeleteWeightedRoutingRequest request,
        ...
        @Override
        public void deleteDanglingIndex(final DeleteDanglingIndexRequest request, final ActionListener<AcknowledgedResponse> listener) {
        ...
        @Override
        public GetStoredScriptRequestBuilder prepareGetStoredScript(final String id) {
        ...
        @Override
        public void putStoredScript(final PutStoredScriptRequest request, final ActionListener<AcknowledgedResponse> listener) {
        ...
        @Override
        public void deleteStoredScript(final DeleteStoredScriptRequest request, final ActionListener<AcknowledgedResponse> listener) {
            execute(DeleteStoredScriptAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> deleteStoredScript(final DeleteStoredScriptRequest request) {
        ...
        @Override
        public DeleteStoredScriptRequestBuilder prepareDeleteStoredScript(final String id) {
            return prepareDeleteStoredScript().setId(id);
        }

        @Override
        public ActionFuture<DecommissionResponse> decommission(final DecommissionRequest request) {
            return execute(DecommissionAction.INSTANCE, request);
        }

        @Override
        public void decommission(final DecommissionRequest request, final ActionListener<DecommissionResponse> listener) {
            execute(DecommissionAction.INSTANCE, request, listener);
        }

        @Override
        public DecommissionRequestBuilder prepareDecommission(final DecommissionRequest request) {
            return new DecommissionRequestBuilder(this, DecommissionAction.INSTANCE, request);
        }

        @Override
        public ActionFuture<GetDecommissionStateResponse> getDecommissionState(final GetDecommissionStateRequest request) {
            return execute(GetDecommissionStateAction.INSTANCE, request);
        }

        @Override
        public void getDecommissionState(final GetDecommissionStateRequest request,
                final ActionListener<GetDecommissionStateResponse> listener) {
        ...
        @Override
        public ActionFuture<DeleteDecommissionStateResponse> deleteDecommissionState(final DeleteDecommissionStateRequest request) {
            return execute(DeleteDecommissionStateAction.INSTANCE, request);
        }

        @Override
        public void deleteDecommissionState(final DeleteDecommissionStateRequest request,
                final ActionListener<DeleteDecommissionStateResponse> listener) {
    ...
    static class IndicesAdmin implements IndicesAdminClient {
        ...
        IndicesAdmin(final OpenSearchClient client) {
            this.client = client;
        }
        ...
        @Override
        public AnalyzeRequestBuilder prepareAnalyze(@Nullable final String index, final String text) {
        ...
        @Override
        public GetIndexTemplatesRequestBuilder prepareGetTemplates(final String... names) {
        ...
        @Override
        public RolloverRequestBuilder prepareRolloverIndex(final String alias) {
        ...
        @Override
        public void createDataStream(final CreateDataStreamAction.Request request, final ActionListener<AcknowledgedResponse> listener) {
            execute(CreateDataStreamAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> createDataStream(final CreateDataStreamAction.Request request) {
            return execute(CreateDataStreamAction.INSTANCE, request);
        }

        @Override
        public void deleteDataStream(final DeleteDataStreamAction.Request request, final ActionListener<AcknowledgedResponse> listener) {
            execute(DeleteDataStreamAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<AcknowledgedResponse> deleteDataStream(final DeleteDataStreamAction.Request request) {
            return execute(DeleteDataStreamAction.INSTANCE, request);
        }

        @Override
        public void getDataStreams(final GetDataStreamAction.Request request, final ActionListener<GetDataStreamAction.Response> listener) {
            execute(GetDataStreamAction.INSTANCE, request, listener);
        }

        @Override
        public ActionFuture<GetDataStreamAction.Response> getDataStreams(final GetDataStreamAction.Request request) {
            return execute(GetDataStreamAction.INSTANCE, request);
        }

        @Override
        public void resolveIndex(final ResolveIndexAction.Request request, final ActionListener<ResolveIndexAction.Response> listener) {
