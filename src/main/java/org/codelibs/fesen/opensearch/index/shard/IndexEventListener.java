 ...
 * via {@link org.codelibs.fesen.opensearch.index.IndexModule#addIndexEventListener(IndexEventListener)}. All listeners have the same
...
public interface IndexEventListener {
    ...
    /**
     * Called after a shard's {@link org.codelibs.fesen.opensearch.index.shard.IndexShardState} changes.
