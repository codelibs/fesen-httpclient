...
import org.codelibs.fesen.opensearch.monitor.fs.FsProbe;
import org.codelibs.fesen.opensearch.node.Node;
import org.codelibs.fesen.opensearch.plugins.BlockCache;
import org.codelibs.fesen.opensearch.plugins.BlockCacheProvider;
...
import org.codelibs.fesen.opensearch.plugins.BlockCacheTieredStats;
...
public class NodeCacheService implements Closeable, BlockCacheRegistry {
     ...
     * Used by {@link org.codelibs.fesen.opensearch.monitor.fs.WarmFsService} for capacity reporting.
     */
    ...
    private static void restoreFileCacheFromDisk(Settings settings, NodeEnvironment.NodePath fileCacheNodePath, FileCache fileCache)
        ...
        if (org.codelibs.fesen.opensearch.cluster.node.DiscoveryNode.isDedicatedWarmNode(settings)) {
     ...
     * {@link org.codelibs.fesen.opensearch.plugins.BlockCacheProvider#requestedCapacityBytes} can receive
