 ...
 * It is created per search request and needs to be set at {@link org.codelibs.fesen.opensearch.index.query.QueryShardContext#setDerivedFieldResolver(DerivedFieldResolver)}
