...
import org.codelibs.fesen.opensearch.index.store.checksum.GenericCRC32ChecksumHandler;
import org.codelibs.fesen.opensearch.index.store.checksum.LuceneChecksumHandler;
    ...
    public String[] listAll() throws IOException {
        ...
        for (int i = 0; i < allFiles.length; i++) {
            ...
            String normalized = allFiles[i].replace(
                org.codelibs.fesen.opensearch.common.io.PathUtils.getDefaultFileSystem().getSeparator().charAt(0),
                '/'
            );
