...
package org.codelibs.fesen.opensearch.index.engine.exec.coord;
...
public class CatalogSnapshotManager implements Closeable {
     ...
     * <p>
     * Typically called after {@link org.codelibs.fesen.opensearch.index.engine.exec.commit.Committer#listCommittedSnapshots()}
     ...
     * {@link org.codelibs.fesen.opensearch.index.engine.exec.CommitFileManager#serializeToCommitFormat}.
     */
     ...
     * Called by the engine after {@link org.codelibs.fesen.opensearch.index.engine.exec.commit.Committer#commit}
