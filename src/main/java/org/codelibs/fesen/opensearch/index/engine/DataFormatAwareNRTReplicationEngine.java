...
import org.codelibs.fesen.opensearch.index.engine.dataformat.DataFormatDescriptor;
...
import org.codelibs.fesen.opensearch.index.engine.exec.CatalogSnapshotDeletionPolicy;
import org.codelibs.fesen.opensearch.index.engine.exec.CatalogSnapshotLifecycleListener;
import org.codelibs.fesen.opensearch.index.engine.exec.CommitFileManager;
...
import org.codelibs.fesen.opensearch.index.engine.exec.commit.Committer.CommitInput;
import org.codelibs.fesen.opensearch.index.engine.exec.commit.Committer.CommitResult;
import org.codelibs.fesen.opensearch.index.engine.exec.commit.CommitterConfig;
import org.codelibs.fesen.opensearch.index.engine.exec.commit.IndexStoreProvider;
...
import org.codelibs.fesen.opensearch.index.store.FileMetadata;
...
import org.codelibs.fesen.opensearch.index.translog.WriteOnlyTranslogManager;
...
public class DataFormatAwareNRTReplicationEngine implements Indexer {
     ...
     * {@link org.codelibs.fesen.opensearch.index.engine.exec.coord.IndexFileDeleter}'s construction-time orphan
     ...
     * {@link org.codelibs.fesen.opensearch.index.engine.exec.coord}.
     */
    // Visible for testing.
     ...
     * {@link org.codelibs.fesen.opensearch.index.store.DataFormatAwareStoreDirectory} via {@code store.directory()},
