...
import org.codelibs.fesen.opensearch.index.mapper.DerivedFieldType;
...
public class VectorGeoPointShapeQueryProcessor {
    ...
    private class ShapeVisitor implements GeometryVisitor<Query, RuntimeException> {
        ...
        @Override
        public Query visit(org.codelibs.fesen.opensearch.geometry.Line line) {
        ...
        public Query visit(MultiPolygon multiPolygon) {
            ArrayList<org.codelibs.fesen.opensearch.geometry.Polygon> collector = new ArrayList<>();
