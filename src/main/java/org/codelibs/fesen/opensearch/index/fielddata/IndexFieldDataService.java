...
import org.codelibs.fesen.opensearch.indices.fielddata.cache.IndicesFieldDataCache.Key;
...
public class IndexFieldDataService extends AbstractIndexComponent implements Closeable {
    ...
    /**
     * Sets a {@link org.codelibs.fesen.opensearch.index.fielddata.IndexFieldDataCache.Listener} passed to each {@link IndexFieldData}
