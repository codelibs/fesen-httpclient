...
import org.codelibs.fesen.opensearch.indices.analysis.PreBuiltCacheFactory;
import org.codelibs.fesen.opensearch.indices.analysis.PreBuiltCacheFactory.CachingStrategy;
...
public final class PreConfiguredTokenizer extends PreConfiguredAnalysisComponent<TokenizerFactory> {
     ...
     * @param create builds the tokenizer
     */
    public static PreConfiguredTokenizer openSearchVersion(String name, Function<org.codelibs.fesen.opensearch.Version, Tokenizer> create) {
