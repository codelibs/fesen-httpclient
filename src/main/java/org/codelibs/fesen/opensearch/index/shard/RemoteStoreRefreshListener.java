...
import org.codelibs.fesen.opensearch.index.engine.InternalEngine;
...
public final class RemoteStoreRefreshListener extends ReleasableRetryableRefreshListener {
    ...
    private static boolean isInternalEngineIndexer(org.codelibs.fesen.opensearch.index.engine.exec.Indexer indexer) {
    ...
    void uploadMetadata(
        ...
        org.codelibs.fesen.opensearch.common.CheckedFunction<CatalogSnapshot, byte[], IOException> serializer = indexShard
