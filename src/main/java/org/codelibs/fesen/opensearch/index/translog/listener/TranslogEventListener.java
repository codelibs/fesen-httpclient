...
package org.codelibs.fesen.opensearch.index.translog.listener;

/**
 * The listener that gets fired on events related to {@link org.codelibs.fesen.opensearch.index.translog.TranslogManager}
 *
 * @opensearch.internal
 */
