...
import org.codelibs.fesen.opensearch.common.geo.GeoLineDecomposer;
import org.codelibs.fesen.opensearch.common.geo.GeoPolygonDecomposer;
import org.codelibs.fesen.opensearch.common.geo.GeoShapeUtils;
...
public class VectorGeoShapeQueryProcessor {
    ...
    private static class LuceneGeometryCollector implements GeometryVisitor<Void, RuntimeException> {
        ...
        @Override
        public Void visit(org.codelibs.fesen.opensearch.geometry.Line line) {
            if (line.isEmpty() == false) {
                List<org.codelibs.fesen.opensearch.geometry.Line> collector = new ArrayList<>();
        ...
        public Void visit(MultiPolygon multiPolygon) {
            if (multiPolygon.isEmpty() == false) {
                List<org.codelibs.fesen.opensearch.geometry.Polygon> collector = new ArrayList<>();
        ...
        @Override
        public Void visit(org.codelibs.fesen.opensearch.geometry.Polygon polygon) {
        ...
        private void collectLines(List<org.codelibs.fesen.opensearch.geometry.Line> geometryLines) {
            for (Line line : geometryLines) {
                geometries.add(GeoShapeUtils.toLuceneLine(line));
            }
        }

        private void collectPolygons(List<org.codelibs.fesen.opensearch.geometry.Polygon> geometryPolygons) {
