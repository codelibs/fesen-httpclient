...
import org.codelibs.fesen.opensearch.lucene.analysis.miscellaneous.DisableGraphAttribute;
        ...
        private Query createQuery(String field, String queryText, Type type, BooleanClause.Occur operator, int phraseSlop) {
            ...
            try (TokenStream source = analyzer.tokenStream(field, queryText)) {
                if (source.hasAttribute(DisableGraphAttribute.class)) {
                     ...
                     * paths explosion. See {@link org.codelibs.fesen.opensearch.index.analysis.ShingleTokenFilterFactory} for details.
                     */
