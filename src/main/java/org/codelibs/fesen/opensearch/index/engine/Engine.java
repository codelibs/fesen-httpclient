...
import org.codelibs.fesen.opensearch.common.lucene.uid.VersionsAndSeqNoResolver.DocIdAndVersion;
...
public abstract class Engine implements LifecycleAware, Closeable {
     ...
     * This allows the engine to include a clean-up {@link org.codelibs.fesen.opensearch.common.CheckedRunnable}
