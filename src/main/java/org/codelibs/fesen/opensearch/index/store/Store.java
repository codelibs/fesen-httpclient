...
import org.codelibs.fesen.opensearch.common.lucene.store.ByteArrayIndexInput;
...
import org.codelibs.fesen.opensearch.common.util.concurrent.RefCounted;
...
import org.codelibs.fesen.opensearch.index.BucketedCompositeDirectory;
import org.codelibs.fesen.opensearch.index.IndexSettings;
import org.codelibs.fesen.opensearch.index.engine.CombinedDeletionPolicy;
...
import org.codelibs.fesen.opensearch.index.engine.exec.coord.LuceneVersionConverter;
...
import org.codelibs.fesen.opensearch.index.shard.AbstractIndexShardComponent;
...
import static org.codelibs.fesen.opensearch.index.store.FsDirectoryFactory.INDEX_LOCK_FACTOR_SETTING;
import static org.codelibs.fesen.opensearch.index.store.Store.MetadataSnapshot.loadMetadata;
...
public class Store extends AbstractIndexShardComponent implements Closeable, RefCounted {
    ...
    public Store(
        ...
        this.isParentFieldEnabledVersion = indexSettings.getIndexVersionCreated().onOrAfter(org.codelibs.fesen.opensearch.Version.V_3_2_0);
    ...
    public boolean shouldSetParentField() {
        return indexSettings.getIndexVersionCreated().onOrAfter(org.codelibs.fesen.opensearch.Version.V_3_2_0) && this.isIndexSortEnabled;
    }
     ...
     * {@link org.codelibs.fesen.opensearch.index.store.Store#shardFormatDirectoryResolver}.
     */
    @ExperimentalApi
    ...
    public static final class MetadataSnapshot implements Iterable<StoreFileMetadata>, Writeable {
        ...
        public static LoadedMetadata loadMetadata(SegmentInfos segmentInfos, Directory directory, Logger logger, boolean ignoreSegmentsFile)
            ...
            if (maxVersion == null) {
                maxVersion = org.codelibs.fesen.opensearch.Version.CURRENT.minimumIndexCompatibilityVersion().luceneVersion;
            }
     ...
     *
     * @see MetadataSnapshot#recoveryDiff(org.codelibs.fesen.opensearch.index.store.Store.MetadataSnapshot)
     *
     * @opensearch.api
     */
    @PublicApi(since = "1.0.0")
    ...
    public interface OnClose extends Consumer<ShardLock> {
        OnClose EMPTY = new OnClose() {
            /**
             * This method is called while the provided {@link org.codelibs.fesen.opensearch.env.ShardLock} is held.
    ...
    /**
     * Returns a {@link org.codelibs.fesen.opensearch.index.seqno.SequenceNumbers.CommitInfo} of the safe commit if exists.
     */
