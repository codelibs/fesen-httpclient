...
import org.codelibs.fesen.opensearch.gateway.remote.IndexMetadataUploadListener;
...
import org.codelibs.fesen.opensearch.repositories.blobstore.ConfigBlobStoreFormat;
...
import static org.codelibs.fesen.opensearch.index.remote.RemoteIndexPath.COMBINED_PATH;
import static org.codelibs.fesen.opensearch.index.remote.RemoteIndexPath.SEGMENT_PATH;
import static org.codelibs.fesen.opensearch.index.remote.RemoteIndexPath.TRANSLOG_PATH;
import static org.codelibs.fesen.opensearch.index.remote.RemoteStoreUtils.determineRemoteStorePathStrategy;
...
/**
 * Uploads the remote store path for all possible combinations of {@link org.codelibs.fesen.opensearch.index.remote.RemoteStoreEnums.DataCategory}
 * and {@link org.codelibs.fesen.opensearch.index.remote.RemoteStoreEnums.DataType} for each shard of an index.
 *
 * @opensearch.internal
 */
@ExperimentalApi
