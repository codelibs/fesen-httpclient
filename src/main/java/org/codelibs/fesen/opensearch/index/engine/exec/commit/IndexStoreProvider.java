 ...
 * <p>
 * Implemented by {@link org.codelibs.fesen.opensearch.index.engine.dataformat.IndexingExecutionEngine}
 * instances that own or wrap a shard-level store. The provider is passed to
 * {@link org.codelibs.fesen.opensearch.plugins.SearchBackEndPlugin#createReaderManager} so that
