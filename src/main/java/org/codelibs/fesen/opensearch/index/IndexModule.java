...
import org.codelibs.fesen.opensearch.common.CheckedTriFunction;
...
import org.codelibs.fesen.opensearch.index.cache.query.DisabledQueryCache;
import org.codelibs.fesen.opensearch.index.cache.query.IndexQueryCache;
...
import org.codelibs.fesen.opensearch.index.engine.exec.DataFormatAwareEngineFactory;
...
import org.codelibs.fesen.opensearch.index.store.FsDirectoryFactory;
import org.codelibs.fesen.opensearch.index.store.Store;
import org.codelibs.fesen.opensearch.index.store.remote.directory.RemoteSnapshotDirectoryFactory;
...
public final class IndexModule {
     ...
     * via {@link org.codelibs.fesen.opensearch.plugins.PluginsService#onIndexModule(IndexModule)}.
     *
