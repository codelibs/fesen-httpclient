...
import org.codelibs.fesen.opensearch.common.blobstore.exception.CorruptFileException;
import org.codelibs.fesen.opensearch.common.blobstore.stream.write.WriteContext;
...
import org.codelibs.fesen.opensearch.index.store.remote.FormatBlobRouter;
...
public class RemoteDirectory extends Directory {
     ...
     * {@link org.codelibs.fesen.opensearch.index.engine.MergedSegmentWarmer}. The key is the local filename and value is the remote filename.
     */
     ...
     * {@link org.codelibs.fesen.opensearch.index.engine.MergedSegmentWarmer}.
     */
