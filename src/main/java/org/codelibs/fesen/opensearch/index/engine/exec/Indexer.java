...
import org.codelibs.fesen.opensearch.index.engine.LifecycleAware;
 ...
 * </ul>
 *
 * @see org.codelibs.fesen.opensearch.index.engine.EngineBackedIndexer for the primary implementation
...
public interface Indexer
     ...
     *   <li>DFA primary: delegates to the {@link org.codelibs.fesen.opensearch.index.engine.exec.coord.CatalogSnapshotManager},
     *       which dispatches to the {@link org.codelibs.fesen.opensearch.index.engine.exec.CommitFileManager}
     ...
     * {@link org.codelibs.fesen.opensearch.index.engine.exec.coord.SegmentInfosCatalogSnapshot}.
     * <p>
     ...
     * underlying {@link org.codelibs.fesen.opensearch.index.engine.Engine}).
     */
     ...
     * Lucene primary delegates through the wrapped {@link org.codelibs.fesen.opensearch.index.engine.Engine};
     ...
     * rather than silently no-op'ing at the {@link org.codelibs.fesen.opensearch.index.shard.IndexShard} layer.
     */
