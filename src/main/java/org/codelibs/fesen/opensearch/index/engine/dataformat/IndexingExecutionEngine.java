...
public interface IndexingExecutionEngine<T extends DataFormat, P extends DocumentInput<?>> extends Closeable {
     ...
     * access to the shard's {@link org.codelibs.fesen.opensearch.index.store.Store} for opening readers.
     * <p>
     ...
     * {@link org.codelibs.fesen.opensearch.index.store.DataFormatAwareStoreDirectory} at shard init time.
     ...
     * Used by {@link org.codelibs.fesen.opensearch.index.engine.DocumentCountTracker} to enforce
