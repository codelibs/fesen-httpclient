...
public record BlockCacheStats(long hits, long misses, long hitBytes, long missBytes, long evictions, long evictionBytes, long removed,
    ...
    public BlockCacheStats(StreamInput in) throws IOException {
        this(
            ...
            in.readLong(),
            in.readLong(),
            in.getVersion().onOrAfter(org.codelibs.fesen.opensearch.Version.V_3_8_0) ? in.readOptionalWriteable(BlockCacheTieredStats::new) : null
        );
    }
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        if (out.getVersion().onOrAfter(org.codelibs.fesen.opensearch.Version.V_3_8_0)) {
