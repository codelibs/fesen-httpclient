 ...
 *
 * @see <a href="https://github.com/opensearch-project/security/blob/main/src/main/java/org/codelibs/fesen/opensearch/security/ssl/SslExceptionHandler.java">SslExceptionHandler</a>
 *
