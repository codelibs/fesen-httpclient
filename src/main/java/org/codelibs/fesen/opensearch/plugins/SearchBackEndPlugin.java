...
public interface SearchBackEndPlugin<R> {
     ...
     * Any components returned that implement {@link org.codelibs.fesen.opensearch.common.lifecycle.LifecycleComponent}
     ...
     * @param namedWriteableRegistry the registry for {@link org.codelibs.fesen.opensearch.core.common.io.stream.NamedWriteable} object parsing
