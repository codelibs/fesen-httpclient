...
import org.codelibs.fesen.opensearch.index.query.QueryParser;
import org.codelibs.fesen.opensearch.index.query.functionscore.ScoreFunctionBuilder;
import org.codelibs.fesen.opensearch.index.query.functionscore.ScoreFunctionParser;
...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.composite.CompositeAggregationParsingFunction;
...
import org.codelibs.fesen.opensearch.search.aggregations.pipeline.MovAvgPipelineAggregator;
...
import org.codelibs.fesen.opensearch.search.query.QueryCollectorContextSpecFactory;
...
import org.codelibs.fesen.opensearch.search.sort.SortParser;
import org.codelibs.fesen.opensearch.search.suggest.Suggest;
import org.codelibs.fesen.opensearch.search.suggest.Suggester;
...
public interface SearchPlugin {
    ...
    class AggregationSpec extends SearchExtensionSpec<AggregationBuilder, ContextParser<String, ? extends AggregationBuilder>> {
        ...
        /**
         * Get the function to register the {@link org.codelibs.fesen.opensearch.search.aggregations.support.ValuesSource} to aggregator mappings for
         * this aggregation
         */
        ...
        /**
         * Set the function to register the {@link org.codelibs.fesen.opensearch.search.aggregations.support.ValuesSource} to aggregator mappings for
         * this aggregation
         */
    ...
    class CompositeAggregationSpec {
         ...
         * {@link org.codelibs.fesen.opensearch.search.aggregations.support.ValuesSource} to aggregator mappings for Composite
         *                            aggregation
