...
import org.codelibs.fesen.opensearch.ingest.Processor;
...
public interface IngestPlugin {
     ...
     * in pipeline configurations, and the value is a {@link org.codelibs.fesen.opensearch.ingest.Processor.Factory}
     ...
     * <p>
     * The key of the returned {@link Map} is the unique name for the processor, and the value is a {@link org.codelibs.fesen.opensearch.ingest.Processor.Factory}
    ...
    class SystemIngestPipelineConfigKeys {
        ...
        /**
         * Use this key to access the settings{@link org.codelibs.fesen.opensearch.common.settings.Settings} of the index from the config.
         */
        public static final String INDEX_SETTINGS = "index_settings";

        /**
         * Use this key to access the settings{@link org.codelibs.fesen.opensearch.common.settings.Settings} of the matched templates
