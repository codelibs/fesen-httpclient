...
import org.codelibs.fesen.opensearch.search.pipeline.Processor;
import org.codelibs.fesen.opensearch.search.pipeline.SearchPhaseResultsProcessor;
import org.codelibs.fesen.opensearch.search.pipeline.SearchPipelineService;
import org.codelibs.fesen.opensearch.search.pipeline.SearchRequestProcessor;
import org.codelibs.fesen.opensearch.search.pipeline.SearchResponseProcessor;
import org.codelibs.fesen.opensearch.search.pipeline.SystemGeneratedProcessor;
...
public interface SearchPipelinePlugin {
     ...
     * in pipeline configurations, and the value is a {@link org.codelibs.fesen.opensearch.search.pipeline.Processor.Factory}
    ...
    class Parameters {
        ...
        /**
         * Allows processors to read headers set by {@link org.codelibs.fesen.opensearch.action.support.ActionFilter}
