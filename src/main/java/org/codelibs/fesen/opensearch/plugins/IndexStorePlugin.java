...
public interface IndexStorePlugin {
     ...
     * {@link org.codelibs.fesen.opensearch.index.IndexModule#INDEX_STORE_TYPE_SETTING} on the index will be examined and either use the default or a
     ...
     * {@link org.codelibs.fesen.opensearch.index.IndexModule#INDEX_COMPOSITE_STORE_TYPE_SETTING} on the index will be examined and either use the default or a
     ...
     * {@link org.codelibs.fesen.opensearch.index.IndexModule#INDEX_RECOVERY_TYPE_SETTING} on the index will be examined and either use the default
