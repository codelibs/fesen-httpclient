...
public class Requests {
     ...
     * @see Client#index(org.codelibs.fesen.opensearch.action.index.IndexRequest)
     */
     ...
     * @see Client#delete(org.codelibs.fesen.opensearch.action.delete.DeleteRequest)
     */
     ...
     * @see Client#get(org.codelibs.fesen.opensearch.action.get.GetRequest)
     */
     ...
     * actual JSON search source, or the {@link org.codelibs.fesen.opensearch.search.builder.SearchSourceBuilder}.
     *
     * @param indices The indices to search against. Use {@code null} or {@code _all} to execute against all indices
     * @return The search request
     * @see Client#search(org.codelibs.fesen.opensearch.action.search.SearchRequest)
     */
     ...
     * @see Client#searchScroll(org.codelibs.fesen.opensearch.action.search.SearchScrollRequest)
     */
