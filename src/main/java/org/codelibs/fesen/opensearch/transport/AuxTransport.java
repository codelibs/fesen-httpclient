...
import static org.codelibs.fesen.opensearch.common.settings.Setting.affixKeySetting;
 ...
 * ports is awkward as {@link org.codelibs.fesen.opensearch.bootstrap.Security} is configured previous to Node initialization during
 * bootstrap. To allow pluggable AuxTransports access to configurable port ranges we require the port range be provided
 * through an {@link org.codelibs.fesen.opensearch.common.settings.Setting.AffixSetting} of the form 'AUX_SETTINGS_PREFIX.{aux-transport-key}.ports'.
 */
@ExperimentalApi
