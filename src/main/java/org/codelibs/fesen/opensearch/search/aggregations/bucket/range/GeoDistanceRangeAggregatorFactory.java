...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.range.GeoDistanceAggregationBuilder.Range;
...
public class GeoDistanceRangeAggregatorFactory extends ValuesSourceAggregatorFactory {
    ...
    private static class DistanceSource extends ValuesSource.Numeric {
        ...
        private final org.codelibs.fesen.opensearch.common.geo.GeoPoint origin;

        DistanceSource(
            ValuesSource.GeoPoint source,
            GeoDistance distanceType,
            org.codelibs.fesen.opensearch.common.geo.GeoPoint origin,
            DistanceUnit units
        ) {
            this.source = source;
