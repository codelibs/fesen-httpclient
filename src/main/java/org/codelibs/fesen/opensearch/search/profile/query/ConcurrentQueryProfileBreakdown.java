...
package org.codelibs.fesen.opensearch.search.profile.query;

import org.apache.lucene.index.LeafReaderContext;
import org.apache.lucene.search.Collector;
import org.codelibs.fesen.opensearch.OpenSearchException;
import org.codelibs.fesen.opensearch.search.profile.AbstractProfileBreakdown;
...
import static org.codelibs.fesen.opensearch.search.profile.Timer.TIMING_TYPE_COUNT_SUFFIX;
import static org.codelibs.fesen.opensearch.search.profile.Timer.TIMING_TYPE_START_TIME_SUFFIX;
...
public final class ConcurrentQueryProfileBreakdown extends ContextualProfileBreakdown {
    ...
    private Set<String> getTimingMetrics() {
        ...
        for (Map.Entry<String, ProfileMetric> entry : metrics.entrySet()) {
            if (entry.getValue() instanceof org.codelibs.fesen.opensearch.search.profile.Timer) {
