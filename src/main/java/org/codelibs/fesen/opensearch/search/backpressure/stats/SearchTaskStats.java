...
package org.codelibs.fesen.opensearch.search.backpressure.stats;
...
public class SearchTaskStats implements ToXContentObject, Writeable {
    ...
    /**
     * Creates a new SearchTaskStats by reading it from the given input.
     *
