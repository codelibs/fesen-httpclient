...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.adjacency.AdjacencyMatrix;
...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.composite.CompositeValuesSourceBuilder;
...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.filter.Filters;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.filter.FiltersAggregationBuilder;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.filter.FiltersAggregator.KeyedFilter;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.global.Global;
...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.missing.Missing;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.missing.MissingAggregationBuilder;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.nested.Nested;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.nested.NestedAggregationBuilder;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.nested.ReverseNested;
...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.sampler.Sampler;
...
import org.codelibs.fesen.opensearch.search.aggregations.metrics.ExtendedStats;
import org.codelibs.fesen.opensearch.search.aggregations.metrics.ExtendedStatsAggregationBuilder;
import org.codelibs.fesen.opensearch.search.aggregations.metrics.GeoCentroid;
...
import org.codelibs.fesen.opensearch.search.aggregations.metrics.PercentileRanks;
...
import org.codelibs.fesen.opensearch.search.aggregations.metrics.ScriptedMetric;
import org.codelibs.fesen.opensearch.search.aggregations.metrics.ScriptedMetricAggregationBuilder;
import org.codelibs.fesen.opensearch.search.aggregations.metrics.Stats;
