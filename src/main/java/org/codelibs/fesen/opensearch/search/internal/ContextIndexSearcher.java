...
import org.codelibs.fesen.opensearch.lucene.util.CombinedBitSet;
...
import org.codelibs.fesen.opensearch.search.dfs.AggregatedDfs;
...
import org.codelibs.fesen.opensearch.search.profile.ContextualProfileBreakdown;
import org.codelibs.fesen.opensearch.search.profile.Timer;
import org.codelibs.fesen.opensearch.search.profile.query.ProfileWeight;
...
public class ContextIndexSearcher extends IndexSearcher implements Releasable {
    ...
    public void search(Query query, Collector collector) throws IOException {
        ...
        // @org.codelibs.fesen.opensearch.search.query.QueryPhase#searchWithCollector which then calls the overridden
     ...
     * runnable throws a {@link RuntimeException} (e.g. {@link org.codelibs.fesen.opensearch.search.query.QueryPhase.TimeExceededException}),
    ...
    private static class MutableQueryTimeout implements ExitableDirectoryReader.QueryCancellation, QueryTimeout {
         ...
         * {@link org.codelibs.fesen.opensearch.search.query.QueryPhase.TimeExceededException} (timeout) or
         * {@link org.codelibs.fesen.opensearch.core.tasks.TaskCancelledException} (task cancellation),
