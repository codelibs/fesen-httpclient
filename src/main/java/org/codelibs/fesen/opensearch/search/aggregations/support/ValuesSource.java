...
import org.codelibs.fesen.opensearch.common.Rounding.Prepared;
import org.codelibs.fesen.opensearch.common.annotation.PublicApi;
import org.codelibs.fesen.opensearch.common.lucene.ScorerAware;
import org.codelibs.fesen.opensearch.core.common.util.CollectionUtils;
import org.codelibs.fesen.opensearch.index.fielddata.AbstractSortingNumericDocValues;
import org.codelibs.fesen.opensearch.index.fielddata.DocValueBits;
import org.codelibs.fesen.opensearch.index.fielddata.GeoShapeValue;
...
import org.codelibs.fesen.opensearch.index.fielddata.IndexNumericFieldData.NumericType;
import org.codelibs.fesen.opensearch.index.fielddata.IndexOrdinalsFieldData;
import org.codelibs.fesen.opensearch.index.fielddata.LeafOrdinalsFieldData;
...
import org.codelibs.fesen.opensearch.index.fielddata.SortingBinaryDocValues;
import org.codelibs.fesen.opensearch.index.fielddata.SortingNumericDoubleValues;
import org.codelibs.fesen.opensearch.index.fielddata.plain.AbstractGeoShapeIndexFieldData;
import org.codelibs.fesen.opensearch.index.mapper.RangeType;
import org.codelibs.fesen.opensearch.script.AggregationScript;
import org.codelibs.fesen.opensearch.search.aggregations.AggregationExecutionException;
import org.codelibs.fesen.opensearch.search.aggregations.support.ValuesSource.Bytes.WithScript.BytesValues;
import org.codelibs.fesen.opensearch.search.aggregations.support.values.ScriptBytesValues;
import org.codelibs.fesen.opensearch.search.aggregations.support.values.ScriptDoubleValues;
import org.codelibs.fesen.opensearch.search.aggregations.support.values.ScriptLongValues;
...
public abstract class ValuesSource {
    ...
    public static class Range extends ValuesSource {
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            return org.codelibs.fesen.opensearch.index.fielddata.FieldData.docsWithValue(bytes);
        }
        ...
        public abstract static class WithOrdinals extends Bytes {
            ...
            public static final WithOrdinals EMPTY = new WithOrdinals() {
                ...
                public SortedBinaryDocValues bytesValues(LeafReaderContext context) throws IOException {
                    return org.codelibs.fesen.opensearch.index.fielddata.FieldData.emptySortedBinary();
                }
            ...
            public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
                ...
                return org.codelibs.fesen.opensearch.index.fielddata.FieldData.docsWithValue(ordinals);
            }
    ...
    public abstract static class Numeric extends ValuesSource {
        ...
        public static final Numeric EMPTY = new Numeric() {
            ...
            public SortedNumericDoubleValues doubleValues(LeafReaderContext context) throws IOException {
                return org.codelibs.fesen.opensearch.index.fielddata.FieldData.emptySortedNumericDoubles();
            }
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            if (isFloatingPoint() || isBigInteger()) {
                ...
                return org.codelibs.fesen.opensearch.index.fielddata.FieldData.docsWithValue(values);
            } else {
    ...
    public abstract static class GeoPoint extends ValuesSource {
        ...
        public static final GeoPoint EMPTY = new GeoPoint() {
            ...
            public MultiGeoPointValues geoPointValues(LeafReaderContext context) {
                return org.codelibs.fesen.opensearch.index.fielddata.FieldData.emptyMultiGeoPoints();
            }
        ...
        public DocValueBits docsWithValue(LeafReaderContext context) throws IOException {
            ...
            return org.codelibs.fesen.opensearch.index.fielddata.FieldData.docsWithValue(geoPoints);
        }
        ...
        public static class Fielddata extends GeoPoint {
            ...
            public org.codelibs.fesen.opensearch.index.fielddata.MultiGeoPointValues geoPointValues(LeafReaderContext context) {
    ...
    public abstract static class GeoShape extends ValuesSource {
        public static final GeoShape EMPTY = new GeoShape() {
            ...
            public GeoShapeValue getGeoShapeValues(LeafReaderContext context) {
                return org.codelibs.fesen.opensearch.index.fielddata.FieldData.emptyGeoShape();
            }
        ...
        /**
         * This is getting used in the {@link org.codelibs.fesen.opensearch.search.aggregations.bucket.missing.MissingAggregator}
         * @param context {@link LeafReaderContext}
         * @return DocValueBits
         */
        @Override
        public DocValueBits docsWithValue(LeafReaderContext context) {
            ...
            return org.codelibs.fesen.opensearch.index.fielddata.FieldData.docsWithValue(geoShapeValue);
        }
