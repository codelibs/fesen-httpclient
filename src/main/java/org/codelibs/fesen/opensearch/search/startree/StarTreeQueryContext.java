...
import org.codelibs.fesen.opensearch.index.compositeindex.datacube.NumericDimension;
...
import org.codelibs.fesen.opensearch.search.aggregations.bucket.histogram.DateHistogramAggregatorFactory;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.range.RangeAggregatorFactory;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.terms.MultiTermsAggregationFactory;
import org.codelibs.fesen.opensearch.search.aggregations.bucket.terms.TermsAggregatorFactory;
import org.codelibs.fesen.opensearch.search.aggregations.metrics.MetricAggregatorFactory;
import org.codelibs.fesen.opensearch.search.internal.SearchContext;
import org.codelibs.fesen.opensearch.search.startree.filter.StarTreeFilter;
import org.codelibs.fesen.opensearch.search.startree.filter.provider.StarTreeFilterProvider;
...
public class StarTreeQueryContext {
    ...
    // TODO : Make changes to change visibility into package private. Handle the same in @org.codelibs.fesen.opensearch.search.SearchServiceStarTreeTests
