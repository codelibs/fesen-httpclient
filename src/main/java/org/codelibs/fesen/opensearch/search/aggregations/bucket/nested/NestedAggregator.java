...
/**
 * Namespace for the nested-aggregation field names. The aggregator itself is node-side and is not carried over.
 *
 * @opensearch.internal
 */
public final class NestedAggregator {

    /** The {@code path} of the nested object to aggregate over. */
