...
package org.codelibs.fesen.opensearch.search.startree.filter.provider;
...
import org.codelibs.fesen.opensearch.index.compositeindex.datacube.DimensionDataType;
...
import org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberFieldType;
import org.codelibs.fesen.opensearch.search.internal.SearchContext;
import org.codelibs.fesen.opensearch.search.startree.filter.DimensionFilter;
import org.codelibs.fesen.opensearch.search.startree.filter.ExactMatchDimFilter;
import org.codelibs.fesen.opensearch.search.startree.filter.MatchNoneFilter;
import org.codelibs.fesen.opensearch.search.startree.filter.RangeMatchDimFilter;
...
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.BYTE;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.DOUBLE;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.FLOAT;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.HALF_FLOAT;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.INTEGER;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.LONG;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.SHORT;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.UNSIGNED_LONG;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.hasDecimalPart;
import static org.codelibs.fesen.opensearch.index.mapper.NumberFieldMapper.NumberType.signum;
...
public interface DimensionFilterMapper {
    ...
    class Factory {
        ...
        private static final Map<String, DimensionFilterMapper> DIMENSION_FILTER_MAPPINGS = Map.of(
            ...
            org.codelibs.fesen.opensearch.index.mapper.KeywordFieldMapper.CONTENT_TYPE,
            new KeywordFieldMapper(),
            UNSIGNED_LONG.typeName(),
            new UnsignedLongFieldMapperNumeric(),
            org.codelibs.fesen.opensearch.index.mapper.IpFieldMapper.CONTENT_TYPE,
            new IpFieldMapper()
        );
