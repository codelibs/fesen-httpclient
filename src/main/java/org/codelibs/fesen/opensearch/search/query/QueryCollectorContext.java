...
import org.codelibs.fesen.opensearch.common.lucene.MinimumScoreCollector;
import org.codelibs.fesen.opensearch.common.lucene.search.FilteredCollector;
import org.codelibs.fesen.opensearch.search.aggregations.AggregationCollectorManager;
import org.codelibs.fesen.opensearch.search.aggregations.BucketCollector;
import org.codelibs.fesen.opensearch.search.profile.query.CollectorResult;
import org.codelibs.fesen.opensearch.search.profile.query.InternalProfileCollector;
import org.codelibs.fesen.opensearch.search.profile.query.InternalProfileCollectorManager;
...
import static org.codelibs.fesen.opensearch.search.profile.query.CollectorResult.REASON_SEARCH_MIN_SCORE;
import static org.codelibs.fesen.opensearch.search.profile.query.CollectorResult.REASON_SEARCH_MULTI;
import static org.codelibs.fesen.opensearch.search.profile.query.CollectorResult.REASON_SEARCH_POST_FILTER;
import static org.codelibs.fesen.opensearch.search.profile.query.CollectorResult.REASON_SEARCH_TERMINATE_AFTER_COUNT;
