 ...
 * <ul>
 *   <li>{@link org.codelibs.fesen.opensearch.search.query.rewriters.BooleanFlatteningRewriter} -
 *       Flattens nested boolean queries with single clauses</li>
 *   <li>{@link org.codelibs.fesen.opensearch.search.query.rewriters.MatchAllRemovalRewriter} -
 *       Removes redundant match_all queries from boolean clauses</li>
 *   <li>{@link org.codelibs.fesen.opensearch.search.query.rewriters.TermsMergingRewriter} -
 *       Merges multiple term queries on the same field into a single terms query</li>
 *   <li>{@link org.codelibs.fesen.opensearch.search.query.rewriters.MustNotToShouldRewriter} -
 *       Transforms must_not queries to should queries for better performance</li>
 *   <li>{@link org.codelibs.fesen.opensearch.search.query.rewriters.MustToFilterRewriter} -
 *       Moves scoring-irrelevant queries from must to filter clauses</li>
 * </ul>
 *
 * @opensearch.internal
 */
package org.codelibs.fesen.opensearch.search.query.rewriters;
