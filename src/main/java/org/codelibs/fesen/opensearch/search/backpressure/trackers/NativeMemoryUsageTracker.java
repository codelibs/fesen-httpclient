...
import org.codelibs.fesen.opensearch.search.backpressure.NativeMemoryUsageService;
...
import static org.codelibs.fesen.opensearch.search.backpressure.trackers.TaskResourceUsageTrackerType.NATIVE_MEMORY_USAGE_TRACKER;
 ...
 * {@link org.codelibs.fesen.opensearch.search.backpressure.SearchBackpressureService} tracker-apply map
 * gates on that).
 *
...
public class NativeMemoryUsageTracker extends TaskResourceUsageTracker {
     ...
     * {@code [0.0, 1.0]} — the {@link org.codelibs.fesen.opensearch.common.settings.Setting} validator
