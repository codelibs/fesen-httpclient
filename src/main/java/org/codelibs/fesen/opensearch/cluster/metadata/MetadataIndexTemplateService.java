...
import org.codelibs.fesen.opensearch.cluster.applicationtemplates.ClusterStateSystemTemplateLoader;
...
import org.codelibs.fesen.opensearch.index.mapper.MapperParsingException;
...
import org.codelibs.fesen.opensearch.indices.IndexTemplateMissingException;
import org.codelibs.fesen.opensearch.indices.IndicesService;
import org.codelibs.fesen.opensearch.indices.InvalidIndexTemplateException;
...
import static org.codelibs.fesen.opensearch.cluster.metadata.MetadataCreateDataStreamService.validateTimestampFieldMapping;
import static org.codelibs.fesen.opensearch.cluster.metadata.MetadataCreateIndexService.validateRefreshIntervalSettings;
import static org.codelibs.fesen.opensearch.cluster.metadata.MetadataCreateIndexService.validateTranslogFlushIntervalSettingsForCompositeIndex;
import static org.codelibs.fesen.opensearch.cluster.metadata.MetadataUpdateSettingsService.validateIndexTotalPrimaryShardsPerNodeSetting;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.CREATE_COMPONENT_TEMPLATE;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.CREATE_INDEX_TEMPLATE;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.CREATE_INDEX_TEMPLATE_V2;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.REMOVE_COMPONENT_TEMPLATE;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.REMOVE_INDEX_TEMPLATE;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.REMOVE_INDEX_TEMPLATE_V2;
import static org.codelibs.fesen.opensearch.common.util.concurrent.ThreadContext.ACTION_ORIGIN_TRANSIENT_NAME;
