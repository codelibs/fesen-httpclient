...
/**
 * Namespace for the shard-state exception a client can see on the wire. Publishing shard state is a node-side concern and is not carried over.
 *
 * @opensearch.internal
 */
public final class ShardStateAction {

    private ShardStateAction() {
    }
