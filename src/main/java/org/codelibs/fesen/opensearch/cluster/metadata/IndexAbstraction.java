...
import static org.codelibs.fesen.opensearch.cluster.metadata.DataStream.getDefaultBackingIndexName;
import static org.codelibs.fesen.opensearch.cluster.metadata.IndexMetadata.INDEX_HIDDEN_SETTING;
...
public interface IndexAbstraction {
    ...
    class DataStream implements IndexAbstraction {
        ...
        private final org.codelibs.fesen.opensearch.cluster.metadata.DataStream dataStream;
