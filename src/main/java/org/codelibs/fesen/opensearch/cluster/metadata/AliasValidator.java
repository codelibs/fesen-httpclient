...
public class AliasValidator {
    ...
    /**
     * Allows to validate an {@link org.codelibs.fesen.opensearch.cluster.metadata.AliasMetadata} and make sure
     * it's valid before it gets added to the index metadata. Doesn't validate the alias filter.
     * @throws IllegalArgumentException if the alias is not valid
     */
     ...
     * provided {@link org.codelibs.fesen.opensearch.index.query.QueryShardContext}
