...
/**
 * Compressor interface used for compressing {@link org.codelibs.fesen.opensearch.core.xcontent.MediaType} and
 * {@code org.codelibs.fesen.opensearch.repositories.blobstore.BlobStoreRepository} implementations.
 * <p>
 * This is not to be confused with {@link org.apache.lucene.codecs.compressing.Compressor} which is used
 * for codec implementations such as {@code org.codelibs.fesen.opensearch.index.codec.customcodecs.Lucene95CustomCodec}
