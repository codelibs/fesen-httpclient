 ...
 * @opensearch.internal
 */
public class PointBuilder extends ShapeBuilder<Point, org.codelibs.fesen.opensearch.geometry.Point, PointBuilder> {
    ...
    @Override
    public org.codelibs.fesen.opensearch.geometry.Point buildGeometry() {
        return new org.codelibs.fesen.opensearch.geometry.Point(coordinates.get(0).x, coordinates.get(0).y);
    }
