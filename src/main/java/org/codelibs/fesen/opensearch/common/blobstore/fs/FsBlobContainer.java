...
package org.codelibs.fesen.opensearch.common.blobstore.fs;
...
import org.codelibs.fesen.opensearch.common.blobstore.support.AbstractBlobContainer;
import org.codelibs.fesen.opensearch.common.blobstore.support.PlainBlobMetadata;
...
/**
 * A file system based implementation of {@link org.codelibs.fesen.opensearch.common.blobstore.BlobContainer}.
 * All blobs in the container are stored on a file system, the location of which is specified by the {@link BlobPath}.
 * <p>
 * Note that the methods in this implementation of {@link org.codelibs.fesen.opensearch.common.blobstore.BlobContainer} may
...
public class FsBlobContainer extends AbstractBlobContainer {
    ...
    private void writeToPath(InputStream inputStream, Path tempBlobPath, long blobSize) throws IOException {
        ...
        try (OutputStream outputStream = Files.newOutputStream(tempBlobPath, StandardOpenOption.CREATE_NEW)) {
            ...
            org.codelibs.fesen.opensearch.common.util.io.Streams.copy(
                inputStream,
                outputStream,
