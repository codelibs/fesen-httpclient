 ...
 * @opensearch.internal
 */
public class EnvelopeBuilder extends ShapeBuilder<Rectangle, org.codelibs.fesen.opensearch.geometry.Rectangle, EnvelopeBuilder> {
    ...
    @Override
    public org.codelibs.fesen.opensearch.geometry.Rectangle buildGeometry() {
        return new org.codelibs.fesen.opensearch.geometry.Rectangle(topLeft.x, bottomRight.x, topLeft.y, bottomRight.y);
    }
