 ...
 * for deprecation logger. For instance <code>DeprecationLogger.getLogger("org.codelibs.fesen.opensearch.test.SomeClass")</code> will
 * result in a deprecation logger with name <code>org.codelibs.fesen.opensearch.deprecation.test.SomeClass</code>. This allows to use a
...
public class DeprecationLogger {
    ...
    private static Logger getDeprecatedLoggerForName(String name) {
        if (name.startsWith("org.codelibs.fesen.opensearch")) {
            name = name.replace("org.codelibs.fesen.opensearch.", "org.codelibs.fesen.opensearch.deprecation.");
        } else {
