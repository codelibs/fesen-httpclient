...
import org.codelibs.fesen.opensearch.common.unit.DistanceUnit.Distance;
 ...
 * @opensearch.internal
 */
public class CircleBuilder extends ShapeBuilder<Circle, org.codelibs.fesen.opensearch.geometry.Circle, CircleBuilder> {
     ...
     * @param radius radius of the circle (see {@link org.codelibs.fesen.opensearch.common.unit.DistanceUnit.Distance})
     * @return this
     */
    ...
    @Override
    public org.codelibs.fesen.opensearch.geometry.Circle buildGeometry() {
        return new org.codelibs.fesen.opensearch.geometry.Circle(center.x, center.y, unit.toMeters(radius));
    }
