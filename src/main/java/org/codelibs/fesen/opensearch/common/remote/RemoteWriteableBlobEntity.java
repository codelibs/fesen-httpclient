...
import static org.codelibs.fesen.opensearch.gateway.remote.RemoteClusterStateUtils.PATH_DELIMITER;
...
public abstract class RemoteWriteableBlobEntity<T> implements RemoteWriteableEntity<T> {
     ...
     * This custom prefix may be generated by any of the strategies defined in {@link org.codelibs.fesen.opensearch.index.remote.RemoteStoreEnums}
