...
package org.codelibs.fesen.opensearch.semver;
...
import org.codelibs.fesen.opensearch.semver.expr.Caret;
import org.codelibs.fesen.opensearch.semver.expr.Equal;
import org.codelibs.fesen.opensearch.semver.expr.Expression;
import org.codelibs.fesen.opensearch.semver.expr.Range;
import org.codelibs.fesen.opensearch.semver.expr.Tilde;
...
/**
 * Represents a single semver range that allows for specifying which {@code org.codelibs.fesen.opensearch.Version}s satisfy the range.
