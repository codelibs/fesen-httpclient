...
import org.codelibs.fesen.opensearch.rest.action.RestCancellableNodeClient;
...
import org.codelibs.fesen.opensearch.search.suggest.term.TermSuggestionBuilder.SuggestMode;
...
import static org.codelibs.fesen.opensearch.action.search.StreamSearchTransportService.STREAM_SEARCH_ENABLED;
...
import static org.codelibs.fesen.opensearch.search.suggest.SuggestBuilders.termSuggestion;
