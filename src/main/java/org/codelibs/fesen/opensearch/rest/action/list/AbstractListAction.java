...
import static org.codelibs.fesen.opensearch.action.pagination.PageParams.PARAM_DESC_SORT_VALUE;

/**
 * Base Transport action class for _list API.
 * Serves as a base class for APIs wanting to support pagination.
 * Existing _cat APIs can refer {@link org.codelibs.fesen.opensearch.rest.action.cat.RestIndicesAction}.
 * @opensearch.api
 */
