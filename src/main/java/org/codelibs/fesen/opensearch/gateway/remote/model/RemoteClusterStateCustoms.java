...
import static org.codelibs.fesen.opensearch.gateway.remote.RemoteClusterStateAttributesManager.CLUSTER_STATE_ATTRIBUTES_CURRENT_CODEC_VERSION;
import static org.codelibs.fesen.opensearch.gateway.remote.RemoteClusterStateUtils.CLUSTER_STATE_EPHEMERAL_PATH_TOKEN;
import static org.codelibs.fesen.opensearch.gateway.remote.RemoteClusterStateUtils.CUSTOM_DELIMITER;
