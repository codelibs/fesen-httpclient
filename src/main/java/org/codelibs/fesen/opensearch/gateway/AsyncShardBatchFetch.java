 ...
 * {@link org.codelibs.fesen.opensearch.indices.store.TransportNodesListShardStoreMetadataBatch}.
 *
...
public abstract class AsyncShardBatchFetch<T extends BaseNodeResponse, V> extends AsyncShardFetch<T> {
     ...
     * {@link org.codelibs.fesen.opensearch.indices.store.TransportNodesListShardStoreMetadataBatch} with memory efficient caching
