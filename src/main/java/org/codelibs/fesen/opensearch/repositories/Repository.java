...
public interface Repository extends LifecycleComponent {
     ...
     * See {@link org.codelibs.fesen.opensearch.plugins.RepositoryPlugin}.
     *
     * @opensearch.api
     */
    @PublicApi(since = "1.0.0")
     ...
     * @param verificationToken value returned by {@link org.codelibs.fesen.opensearch.repositories.Repository#startVerification()}
     ...
     * <p>
     * The index commit point can be obtained by using {@link org.codelibs.fesen.opensearch.index.engine.Engine#acquireLastIndexCommit} method.
     ...
     * <p>
     * The index commit point can be obtained by using {@link org.codelibs.fesen.opensearch.index.engine.Engine#acquireLastIndexCommit} method.
     * Or for closed index can be obtained by reading last remote uploaded metadata by using {@link org.codelibs.fesen.opensearch.index.shard.IndexShard#fetchLastRemoteUploadedSegmentMetadata()} method.
     * Repository implementations shouldn't release the snapshot index commit point. It is done by the method caller.
     * <p>
     * As snapshot process progresses, implementation of this method should update {@link IndexShardSnapshotStatus} object and check
     * {@link IndexShardSnapshotStatus#isAborted()} to see if the snapshot process should be aborted.
     ...
     * thus the same semantics as with {@link org.codelibs.fesen.opensearch.cluster.ClusterStateApplier#applyClusterState} apply for the
