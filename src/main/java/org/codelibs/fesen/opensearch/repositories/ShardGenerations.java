...
public final class ShardGenerations {
     ...
     * {@link org.codelibs.fesen.opensearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for it.
     */
    ...
    /**
     * Get the generation of the {@link org.codelibs.fesen.opensearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob for a given index
     * and shard.
     ...
     * @return generation of the {@link org.codelibs.fesen.opensearch.index.snapshots.blobstore.BlobStoreIndexShardSnapshots} blob
     */
    @Nullable
