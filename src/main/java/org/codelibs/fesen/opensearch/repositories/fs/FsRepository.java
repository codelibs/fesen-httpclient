...
package org.codelibs.fesen.opensearch.repositories.fs;
...
import org.codelibs.fesen.opensearch.common.blobstore.fs.FsBlobStore;
...
public class FsRepository extends BlobStoreRepository {
     ...
     * {@link org.codelibs.fesen.opensearch.plugins.ExtensiblePlugin}, FsRepository is a built-in
     * repo type (not a plugin). The native provider is passed from
     * {@link org.codelibs.fesen.opensearch.repositories.RepositoriesModule} which discovers it
