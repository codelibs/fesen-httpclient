...
import org.codelibs.fesen.opensearch.repositories.blobstore.MeteredBlobStoreRepository;
...
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.DELETE_REPOSITORY;
import static org.codelibs.fesen.opensearch.cluster.service.ClusterManagerTask.PUT_REPOSITORY;
...
public class RepositoriesService extends AbstractLifecycleComponent implements ClusterStateApplier {
    ...
    public static void validate(final String identifier) {
        if (org.codelibs.fesen.opensearch.core.common.Strings.hasLength(identifier) == false) {
