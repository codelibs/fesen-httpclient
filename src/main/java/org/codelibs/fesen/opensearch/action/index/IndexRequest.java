...
import org.codelibs.fesen.opensearch.action.support.replication.ReplicatedWriteRequest;
 ...
 * created using {@code Requests#indexRequest(String)}.
 * <p>
 * The index requires the {@link #index()}, {@link #id(String)} and
 * {@code #source(byte[], MediaType)} to be set.
 * <p>
 * The source (content to index) can be set in its bytes form using ({@code #source(byte[], MediaType)}),
...
public class IndexRequest extends ReplicatedWriteRequest<IndexRequest> implements DocWriteRequest<IndexRequest>, CompositeIndicesRequest {
    ...
    /**
     * Value for {@code #getAutoGeneratedTimestamp()} if the document has an external
     * provided ID.
     */
    ...
    /**
     * Sets the content source to index using the default content type ({@code Requests#INDEX_CONTENT_TYPE})
     * <p>
