...
public class BulkProcessor implements Closeable {
    ...
    public static class Builder {
         ...
         *
         * @see org.codelibs.fesen.opensearch.action.bulk.BackoffPolicy#exponentialBackoff()
         */
     ...
     * @param listener The BulkProcessor listener that gets called on bulk events
     * @return the builder for BulkProcessor
     * @deprecated Use {@link #builder(java.util.function.BiConsumer, org.codelibs.fesen.opensearch.action.bulk.BulkProcessor.Listener)}
     * with client::bulk as the first argument, or {@link #builder(Client,
     * org.codelibs.fesen.opensearch.action.bulk.BulkProcessor.Listener, org.codelibs.fesen.opensearch.threadpool.Scheduler,
     * org.codelibs.fesen.opensearch.threadpool.Scheduler, java.lang.Runnable)} and manage the flush and retry schedulers explicitly
     */
    @Deprecated
