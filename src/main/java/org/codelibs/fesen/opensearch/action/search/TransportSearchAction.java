...
import org.codelibs.fesen.opensearch.action.search.pruning.FieldDomainEvaluationContext;
import org.codelibs.fesen.opensearch.action.search.pruning.SearchIndexPruningResult;
...
import org.codelibs.fesen.opensearch.action.support.TimeoutTaskCancellationUtility;
...
import org.codelibs.fesen.opensearch.index.fielddomain.ClusterStateFieldDomainProvider;
...
import org.codelibs.fesen.opensearch.search.pipeline.PipelinedRequest;
...
import org.codelibs.fesen.opensearch.telemetry.tracing.Span;
import org.codelibs.fesen.opensearch.telemetry.tracing.SpanBuilder;
import org.codelibs.fesen.opensearch.telemetry.tracing.SpanScope;
import org.codelibs.fesen.opensearch.telemetry.tracing.Tracer;
import org.codelibs.fesen.opensearch.telemetry.tracing.listener.TraceableActionListener;
import org.codelibs.fesen.opensearch.telemetry.tracing.listener.TraceableSearchRequestOperationsListener;
...
import static org.codelibs.fesen.opensearch.action.admin.cluster.node.tasks.get.GetTaskAction.TASKS_ORIGIN;
import static org.codelibs.fesen.opensearch.action.search.SearchType.DFS_QUERY_THEN_FETCH;
import static org.codelibs.fesen.opensearch.action.search.SearchType.QUERY_THEN_FETCH;
import static org.codelibs.fesen.opensearch.search.sort.FieldSortBuilder.hasPrimaryFieldSort;
