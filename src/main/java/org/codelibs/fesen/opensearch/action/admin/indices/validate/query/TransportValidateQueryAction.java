...
import org.codelibs.fesen.opensearch.action.support.broadcast.BroadcastShardOperationFailedException;
import org.codelibs.fesen.opensearch.action.support.broadcast.TransportBroadcastAction;
...
public class TransportValidateQueryAction extends TransportBroadcastAction<
    ...
    protected void doExecute(Task task, ValidateQueryRequest request, ActionListener<ValidateQueryResponse> listener) {
        ...
        ActionListener<org.codelibs.fesen.opensearch.index.query.QueryBuilder> rewriteListener = ActionListener.wrap(rewrittenQuery -> {
