...
/**
 * Namespace for the replica-retry exception a client can see on the wire. Running a replication action is a node-side concern and is not carried over.
 *
 * @opensearch.internal
 */
public final class TransportReplicationAction {

    private TransportReplicationAction() {
    }
