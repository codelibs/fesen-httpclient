...
public interface SearchPhaseContext extends Executor {
    ...
    /**
     * Returns a connection to the node if connected otherwise and {@link org.codelibs.fesen.opensearch.transport.ConnectTransportException} will be
     * thrown.
     */
     ...
     * @see org.codelibs.fesen.opensearch.search.query.QuerySearchResult#getContextId()
     * @see org.codelibs.fesen.opensearch.search.fetch.FetchSearchResult#getContextId()
     *
     */
