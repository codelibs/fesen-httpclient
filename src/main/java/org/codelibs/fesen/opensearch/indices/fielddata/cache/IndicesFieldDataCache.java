...
package org.codelibs.fesen.opensearch.indices.fielddata.cache;
...
import org.codelibs.fesen.opensearch.index.fielddata.LeafFieldData;
import org.codelibs.fesen.opensearch.index.shard.ShardUtils;
...
public class IndicesFieldDataCache implements RemovalListener<IndicesFieldDataCache.Key, Accountable>, Releasable {
    ...
    static class IndexFieldCache implements IndexFieldDataCache, IndexReader.ClosedListener {
        ...
        /**
         * Per-shard listeners (e.g. {@link org.codelibs.fesen.opensearch.index.fielddata.ShardFieldData}). Skipped
