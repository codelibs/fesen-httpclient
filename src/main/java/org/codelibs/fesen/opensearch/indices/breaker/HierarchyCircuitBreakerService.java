...
package org.codelibs.fesen.opensearch.indices.breaker;

import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.apache.logging.log4j.message.ParameterizedMessage;
import org.codelibs.fesen.opensearch.common.Booleans;
import org.codelibs.fesen.opensearch.common.breaker.ChildMemoryCircuitBreaker;
...
import org.codelibs.fesen.opensearch.core.common.breaker.NoopCircuitBreaker;
...
import org.codelibs.fesen.opensearch.monitor.jvm.GcNames;
...
import static org.codelibs.fesen.opensearch.indices.breaker.BreakerSettings.CIRCUIT_BREAKER_LIMIT_SETTING;
import static org.codelibs.fesen.opensearch.indices.breaker.BreakerSettings.CIRCUIT_BREAKER_OVERHEAD_SETTING;
...
public class HierarchyCircuitBreakerService extends CircuitBreakerService {
    ...
    private static final String CHILD_LOGGER_PREFIX = "org.codelibs.fesen.opensearch.indices.breaker.";
