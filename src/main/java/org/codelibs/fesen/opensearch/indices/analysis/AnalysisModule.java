...
package org.codelibs.fesen.opensearch.indices.analysis;
...
import org.codelibs.fesen.opensearch.index.analysis.AnalyzerProvider;
import org.codelibs.fesen.opensearch.index.analysis.CharFilterFactory;
import org.codelibs.fesen.opensearch.index.analysis.HunspellTokenFilterFactory;
import org.codelibs.fesen.opensearch.index.analysis.KeywordAnalyzerProvider;
import org.codelibs.fesen.opensearch.index.analysis.LowercaseNormalizerProvider;
import org.codelibs.fesen.opensearch.index.analysis.PreBuiltAnalyzerProviderFactory;
import org.codelibs.fesen.opensearch.index.analysis.PreConfiguredCharFilter;
import org.codelibs.fesen.opensearch.index.analysis.PreConfiguredTokenFilter;
import org.codelibs.fesen.opensearch.index.analysis.PreConfiguredTokenizer;
import org.codelibs.fesen.opensearch.index.analysis.ShingleTokenFilterFactory;
import org.codelibs.fesen.opensearch.index.analysis.SimpleAnalyzerProvider;
import org.codelibs.fesen.opensearch.index.analysis.StandardAnalyzerProvider;
import org.codelibs.fesen.opensearch.index.analysis.StandardTokenizerFactory;
import org.codelibs.fesen.opensearch.index.analysis.StopAnalyzerProvider;
import org.codelibs.fesen.opensearch.index.analysis.StopTokenFilterFactory;
import org.codelibs.fesen.opensearch.index.analysis.TokenFilterFactory;
import org.codelibs.fesen.opensearch.index.analysis.TokenizerFactory;
import org.codelibs.fesen.opensearch.index.analysis.WhitespaceAnalyzerProvider;
...
import static org.codelibs.fesen.opensearch.plugins.AnalysisPlugin.requiresAnalysisSettings;
