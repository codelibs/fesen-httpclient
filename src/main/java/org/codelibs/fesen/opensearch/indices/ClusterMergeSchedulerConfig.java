...
import static org.codelibs.fesen.opensearch.common.util.concurrent.OpenSearchExecutors.NODE_PROCESSORS_SETTING;
import static org.codelibs.fesen.opensearch.index.MergeSchedulerConfig.DEFAULT_AUTO_THROTTLE;
 ...
 *
 * <h2>Examples</h2>
 * See {@code org.codelibs.fesen.opensearch.index.ClusterMergeSchedulerConfigsIT} for detailed examples of all configuration scenarios.
 *
