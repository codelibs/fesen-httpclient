...
package org.codelibs.fesen.opensearch.monitor.jvm;
...
public class HotThreads {
    ...
    private static boolean isIdleThread(ThreadInfo threadInfo) {
        ...
        for (StackTraceElement frame : threadInfo.getStackTrace()) {
            ...
            if (className.equals("org.codelibs.fesen.opensearch.threadpool.ThreadPool$CachedTimeThread") && methodName.equals("run")) {
                return true;
            }
            if (className.equals("org.codelibs.fesen.opensearch.indices.ttl.IndicesTTLService$Notifier") && methodName.equals("await")) {
                return true;
            }
